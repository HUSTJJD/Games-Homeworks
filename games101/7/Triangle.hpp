...
public:
    ...
    // Home Work Begin
    MeshTriangle(const std::string &filename, Material *mt = new Material(), Vector3f Trans = Vector3f(0.0, 0.0, 0.0), Vector3f Scale = Vector3f(1.0, 1.0, 1.0))
    // Home Work End
    {
        objl::Loader loader;
        ...
        for (int i = 0; i < mesh.Vertices.size(); i += 3)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                ...
                // Home Work Begin
                face_vertices[j] = Scale * vert + Trans;
                // Home Work End
